...
Replace the [components.py, sim.py and interactions.py] in your calvados package (located in site-packages in your conda environment)  
...
dihdomains =  f'{cwd}/input/dih_domains.yaml' # this is the residues for which you wish to apply the dih restraints  
